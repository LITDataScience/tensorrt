...
The input to the script is a SavedModel directory that includes
...
python object_detection.py \
    --input_saved_model_dir /models/ssd_mobilenet_v2_coco_640_bs8 \
...
Optional integrity check (hashes the **entire** SavedModel tree):

```bash
DIGEST=$(python ../hash_saved_model.py --quiet /models/ssd_mobilenet_v2_coco_640_bs8)
python object_detection.py ... --model_sha256=$DIGEST
```
